...
After deploying the Vms, connect to (**master01 and worker01**).

This implementation will deploy the internal **etcd**, maintained and managed by **kubelet**.

It will be asking how **etcd**will run, at the time I am running with etcd **internal**. There is material talking only about **ETCD**, see [Menu](https://github.com/Paulo-Rogerio/kubernetes-certifications/blob/main/README.md).
...
After deploying **master01**, connect to **worker01**and perform a similar procedure.
